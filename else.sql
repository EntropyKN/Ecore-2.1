...
--
-- Host: localhost:3306
-- Creato il: Ott 25, 2022 alle 10:45
-- Versione del server: 5.7.38-log
-- Versione PHP: 7.4.30
...
CREATE TABLE `email_validation` (
  ...
  `validationIP` varchar(12) DEFAULT NULL,
  `id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `games_spread` (
  `gameId` int(11) NOT NULL,
  `spread` enum('L1','L2','L3','L4','W1','W2','W3','W4') DEFAULT NULL,
  `spreadLP` decimal(10,2) DEFAULT NULL,
  `spreadRP` decimal(10,2) DEFAULT NULL,
  `spreadL` decimal(10,2) DEFAULT NULL,
  `spreadR` decimal(10,2) DEFAULT NULL,
...
(1, NULL, 0, 'entropy', 'user', 'user1', 'User', 'One', 'xxx@xxx', '', NULL, NULL, NULL, NULL, 'na', '0000-00-00', 0, 1615907358, 1615907358),
(2, NULL, 1, 'entropy', 'editor', 'editor1', 'User', 'two', 'xxx@xxx1', '', NULL, NULL, NULL, NULL, 'na', '0000-00-00', 0, 1615907358, 1615907358);
...
CREATE TABLE `usersgroups` (
  ...
  `orderg` smallint(3) NOT NULL DEFAULT '1',
...
--
ALTER TABLE `users`
  MODIFY `users_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
