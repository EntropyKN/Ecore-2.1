...
//	if ($future && $distanceInhours==1) return L_TIME_in." ".$distanceInhours." ".L_hour.$add;
	...
	if ($future && $distanceInMonths<=13) return L_TIME_in." ".$distanceInMonths." ".L_months.$add;
	if (!$future && $distanceInMonths<=13) return L_TIME_ago_pre." ".$distanceInMonths." ".L_months." ".L_TIME_ago_post.$add;	
